...
import '../add_expense/widget/my_filter.dart';
...
class _DashBoardScreenState extends State<DashBoardScreen> {
  ...
  FloatingActionButton buildAddBtn(BuildContext context) {
  ...
  Positioned buildHomeCard(DashboardStates state) {
    return Positioned(
      top: .19.sh,
      left: 0,
      right: 0,
